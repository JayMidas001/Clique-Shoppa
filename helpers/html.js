const signUpTemplate = (verifyLink, fullName) => {
  return `
    ...
    <head>
      ...
      <title>Welcome to Clique Shoppa!</title>
      <style>
        body {
    ...
    <body>
      <div class="container">
        <div class="header">
          <h1>Welcome to Clique Shoppa!</h1>
        </div>
        <div class="content">
          <p>Hello, ${fullName},</p>
          ...
          <p>Best regards,<br>The Clique Shoppa Team</p>
        </div>
        <div class="footer">
          <p>&copy; ${new Date().getFullYear()} Clique Shoppa. All rights reserved.</p>
        </div>
      </div>
    </body>
    </html>
